...
class AddDelRecipeSerializer(serializers.ModelSerializer):
    """Миксин с общими методами для нескольких сериализаторов."""
...
class FavoriteSerializer(AddDelRecipeSerializer):
    """Сериализатор для работы с избранными рецептами."""

    class Meta(AddDelRecipeSerializer.Meta):
        model = Favorite
        fields = "__all__"
        validators = [
            UniqueTogetherValidator(
...
class ShoppingCartSerializer(AddDelRecipeSerializer):
